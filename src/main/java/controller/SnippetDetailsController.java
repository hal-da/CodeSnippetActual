...
public class SnippetDetailsController {
    ...
    public SnippetDetailsController() throws SQLException {
    }
    ...
    void handlerBtnEditLanguage() throws SQLException {
        ...
        EditLanguageWindowController editLanguageWindowController = new EditLanguageWindowController();
        editLanguageWindowController.showLanguageEditWindow(changedLanguage);
        Stage stage = editLanguageWindowController.getStage();
        stage.showAndWait();
